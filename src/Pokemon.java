class Pokemon {
    ...
    public Pokemon(int numeroNational, String nom, String typePrincipal, String typeSecondaire, int niveau, int pointsDeVie, int attaque, int defense, int attaqueSpeciale, int defenseSpeciale, int vitesse) {
    ...
    public String getTypePrincipal() { return typePrincipal; }
    public void setTypePrincipal(String typePrincipal) { this.typePrincipal = typePrincipal; }
    ...
    public String toString() {
        return "Numéro National: " + numeroNational + ", Nom: " + nom + ", Type Principal: " + typePrincipal +
                ", Type Secondaire: " + typeSecondaire + ", Niveau: " + niveau + ", PV: " + pointsDeVie +
                ", Attaque: " + attaque + ", Défense: " + defense + ", Attaque Spéciale: " + attaqueSpeciale +
                ", Défense Spéciale: " + defenseSpeciale + ", Vitesse: " + vitesse;
    }

    public int calculerDommage(Pokemon adversaire, int puissance) {
        return (int)(((2 * niveau / 5 + 2) * puissance * attaque / adversaire.getDefense()) / 50 + 2);
    }
}
